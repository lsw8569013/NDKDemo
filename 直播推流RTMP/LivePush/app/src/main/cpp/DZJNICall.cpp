...
DZJNICall::DZJNICall(JavaVM *javaVM, JNIEnv *jniEnv, jobject jCallObj) {
    ...
    // 需要回调的java层的方法
    jclass jCallClass = jniEnv->GetObjectClass(jCallObj);
    jConnectErrorMid = jniEnv->GetMethodID(jCallClass, "onConnectError",
                                           "(ILjava/lang/String;)V");
    jConnectSuccessMid = jniEnv->GetMethodID(jCallClass, "onConnectSuccess", "()V");
//    jPlayerPrepardMid = jniEnv->GetMethodID(jCallClass, "onPrepared", "()V");
