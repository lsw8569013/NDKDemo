...
extern "C"
JNIEXPORT void JNICALL
Java_com_darren_media_DarrenPlayer_nStop(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_darren_media_DarrenPlayer_nTest(JNIEnv *env, jobject instance, jbyteArray url_) {
